...
Website projects that use **CloudCannon** for **Git-backed content editing** and visual previews. Confirm each client in Notion—some sites use Webflow-only or Astro-only CMS.

## Source of truth

- **Git** remains canonical for content and structure; CloudCannon edits **commit back** to the repo.
- **Notion** stays the project’s operational source of truth for URLs, stakeholders, and approvals—not CloudCannon’s UI alone.
