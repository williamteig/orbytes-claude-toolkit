...
- **Custom domains** and **HTTPS** live in the Cloudflare dashboard—document canonical URLs in Notion, not only in dashboard UI.
...
- **Vars** for non-secret config (public URLs, feature flags) can live in Wrangler or env-specific config—keep parity with how the project documents env in `README` / Notion.
